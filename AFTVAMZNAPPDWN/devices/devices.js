...
var Devices = {
	...
	add: function(a, b) {
		Devices.getAll(function(c) {
			c.push(a), Devices.saveAll(c, b)
		})
	},
	remove: function(a, b) {
		Devices.getAll(function(c) {
			c[a] && c.splice(a, 1), b && b()
		})
	}
};